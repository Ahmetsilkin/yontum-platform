'use client';
import{useEffect,useMemo,useState}from'react';import{useParams}from'next/navigation';import'@/components/tenant.css';
...
export default function AppointmentPage(){
  ...
  const slots=useMemo(()=>{
    ...
    const out=[];
    const interval=data?.businesses?.slot_interval||30;
