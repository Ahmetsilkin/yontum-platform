...
export default function Layout({children}:{children:React.ReactNode}){return <html lang="tr"><head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&family=Plus+Jakarta+Sans:wght@500;600;700;800&family=Archivo+Black&family=Space+Grotesk:wght@400;500;700&family=Quicksand:wght@500;600;700&family=Nunito:wght@400;500;600;700&family=Zilla+Slab:wght@400;500;600;700&family=Caveat:wght@500;600;700&family=Montserrat:wght@700;800;900&family=Lato:wght@400;500;700&display=swap" rel="stylesheet"/>
